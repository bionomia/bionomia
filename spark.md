...
```bash
$ spark-shell --jars /usr/local/opt/mysql-connector-java/libexec/mysql-connector-j-9.1.0.jar --packages org.apache.spark:spark-avro_2.12:3.5.3 --driver-memory 12G
```
