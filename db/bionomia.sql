...
CREATE TABLE agents (
  ...
  nick varchar(25) COLLATE utf8mb4_bin DEFAULT NULL,
  suffix varchar(25) COLLATE utf8mb4_bin DEFAULT NULL,
  dropping_particle varchar(25) COLLATE utf8mb4_bin DEFAULT NULL,
  particle varchar(25) COLLATE utf8mb4_bin DEFAULT NULL,
  title varchar(25) COLLATE utf8mb4_bin DEFAULT NULL,
  appellation varchar(25) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE datasets (
  ...
  administrative_contact text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
...
CREATE TABLE missing_occurrences (
  ...
  dateIdentified_processed_year int DEFAULT NULL,
  dateIdentified_processed_month int DEFAULT NULL,
  dateIdentified_processed_day int DEFAULT NULL,
  eventDate_processed date DEFAULT NULL,
  eventDate_processed_year int DEFAULT NULL,
  eventDate_processed_month int DEFAULT NULL,
  eventDate_processed_day int DEFAULT NULL,
...
CREATE TABLE users (
  ...
  wants_mail tinyint(1) DEFAULT '0',
...
ALTER TABLE agents
  ADD PRIMARY KEY (id),
  ADD UNIQUE KEY full_name (family,given,particle,appellation,title,suffix,nick,dropping_particle,unparsed);
...
ALTER TABLE missing_occurrences
  ...
  ADD KEY catalogNumber_idx (catalogNumber(150)),
  ADD KEY occurrenceID_idx (occurrenceID(125)),
  ADD KEY index_occurrences_on_datasetKey_occurrenceID (datasetKey,occurrenceID(36)) USING BTREE;
