      ...
      def package_metadata
         {
            ...
            description: "Natural history specimen data linked to collectors and determiners held within, \"#{@resource.title}\". Claims or attributions were made on Bionomia by volunteer Scribes, <a href=\"https://bionomia.net/dataset/#{@resource.uuid}\">https://bionomia.net/dataset/#{@resource.uuid}</a> using specimen data from the dataset aggregated by the Global Biodiversity Information Facility, <a href=\"https://gbif.org/dataset/#{@resource.uuid}\">https://gbif.org/dataset/#{@resource.uuid}</a>. Formatted as a Frictionless Data package.",
            access_right: "open",
            license: "cc-zero",
